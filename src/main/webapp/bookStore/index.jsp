...
<body>
    ...
    <header class="header-container">
   		 <iframe id = "header" src="./pages/header.jsp" frameborder="0" width="100%" height="240" scrolling="no"></iframe>
    </header>
                    ...
                    <div id="bestseller" class="tab-box con1">
                        ...
                        <ul class="best-list">
                            <li>
                                ...
                                <a href="./pages/bookDetail.jsp?book_id=114">
                            ...
                            <li><span class="rank">2</span>
                                <a href="./pages/bookDetail.jsp?book_id=123">
                            ...
                            <li><span class="rank">3</span>
                                <a href="./pages/bookDetail.jsp?&book_id=130">
                            ...
                            <li><span class="rank">4</span>
                                <a href="./pages/bookDetail.jsp?book_id=122">
                            ...
                            <li><span class="rank">5</span>
                                <a href="./pages/bookDetail.jsp?book_id=104">
        ...
        <section class="new-books">
            ...
            <div class="book-list">
                <div class="item-inner">
                    <div class="book">
                        <a href="./pages/bookDetail.jsp?book_id=110">
                ...
                <div class="item-inner">
                    <div class="book">
                    	<a href="./pages/bookDetail.jsp?book_id=112">
                ...
                <div class="item-inner">
                    <div class="book">
                    	<a href="./pages/bookDetail.jsp?book_id=113">
                ...
                <div class="item-inner">
                    <div class="book">
                    	<a href="./pages/bookDetail.jsp?book_id=101">
            ...
            <button class="more"><a href="./pages/new.jsp">더보기 →</a></button>
        </section>
        ...
        <section class="today-book">
            ...
            <div class="content">
                <div class="content-large">
                    <div class="book-cover" onclick="location.href='./pages/bookDetail.jsp?book_id=132';">
                ...
                <div class="content-small">
                    <div class="book-inner">
                        <div class="book-small" onclick="location.href='./pages/bookDetail.jsp?book_id=114';">
                            <img src="./assets/images/book/humanActs.jpg" >
                            <div class="overlay">
                                <p class="book-quote">"당신이 나를 밝은 쪽으로, 빛이 비치는 쪽으로, 꽃이 핀 쪽으로 끌고 가기를 바랍니다."</p>
                            </div>
                        </div>
                        <div class="book-small" onclick="location.href='./pages/bookDetail.jsp?book_id=133';">
                            <img src="./assets/images/book/nolongerhuman.jpg">
                            <div class="overlay">
                                <p class="book-quote">"부끄럼 많은<br> 생애를 보냈습니다."</p>
                            </div>
                        </div>
                        <div class="book-small" onclick="location.href='./pages/bookDetail.jsp?book_id=123';">
                            <img src="./assets/images/book/buddha'sWords.jpg">
                            <div class="overlay">
    ...
    <footer class="footer-container">
       <iframe id = "footer" src="./pages/footer.jsp" frameborder="0" width="100%" height="240" scrolling="no"></iframe>
    </footer>
