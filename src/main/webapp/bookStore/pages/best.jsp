...
<body>
    ...
    <div class="wrapper">
        ...
        <div id = "current-position">
            <ol class="items-center">
                <li class="relative items-center">
                    <a href="./../index.jsp"><img src="./../assets/images/home.png">
                    </a>
                </li>
                <li class="best-page">
                    <a href="best.jsp">&nbsp;/&nbsp;베스트셀러</a></li>
            </ol>
        </div>
        ...
        <form action="cartMultiAdd.jsp" method="post" id="multiAdd">
	        <nav class="items-end">
	            ...
	            <aside class="left-space"></aside>  
	                <section class="book-list">
	                    ...
	                    <div class="book-item">
	                        ...
	                        <div class="book-image"><a href="bookDetail.jsp?book_id=114">
	                            <img src="./../assets/images/book/humanActs.jpg"></a></div>
	                        <div class="book-info">
	                            <div class="book-ranking">1</div>
	                            <div class="book-title"><a href="bookDetail.jsp?book_id=114">소년이 온다</a></div>
	                        ...
	                        <div class="buttons">
	                            <a href="cartAdd.jsp?book_id=114"><button type="button" class="cart-btn"><img src="./../assets/images/cart.jpg">&nbsp;장바구니</button></a>
	                            <a href="orderAdd.jsp?book_id=114"><button type="button" class="buy-btn">바로구매</button></a>
	                        </div>
	                    </div>
	                    ...
	                    <div class="book-item">
	                        ...
	                        <div class="book-image"><a href="bookDetail.jsp?book_id=123">
	                            <img src="./../assets/images/book/buddha'sWords.jpg"></a>
	                        </div>
	                        <div class="book-info">
	                            <div class="book-ranking">2</div>
	                            <div class="book-title"><a href="bookDetail.jsp?book_id=123">초역 부처의 말</a></div>
	                        ...
	                        <div class="buttons">
	                            <a href="cartAdd.jsp?book_id=123"><button type="button" class="cart-btn"><img src="./../assets/images/cart.jpg">&nbsp;장바구니</button></a>
	                            <a href="orderAdd.jsp?book_id=123"><button type="button" class="buy-btn">바로구매</button></a>
	                        </div>
	                    </div>
	                    ...
	                    <div class="book-item">
	                        ...
	                        <div class="book-image"><a href="bookDetail.jsp?book_id=130">
	                            <img src="./../assets/images/book/stopTheStill.jpg"></a>
	                        </div>
	                        <div class="book-info">
	                            <div class="book-ranking">3</div>
	                            <div class="book-title"><a href="bookDetail.jsp?book_id=130">STOP THE STEAL 대법원의 부정선거 은폐기록</a></div>
	                        ...
	                        <div class="buttons">
	                            <a href="cartAdd.jsp?book_id=130"><button type="button" class="cart-btn"><img src="./../assets/images/cart.jpg">&nbsp;장바구니</button></a>
	                            <a href="orderAdd.jsp?book_id=130"><button type="button" class="buy-btn">바로구매</button></a>
	                        </div>
	                    </div>
	                    ...
	                    <div class="book-item">
	                        ...
	                        <div class="book-image"><a href="bookDetail.jsp?book_id=122">
	                            <img src="./../assets/images/book/vegetarian.jpg"></a>
	                        </div>
	                        <div class="book-info">
	                            <div class="book-ranking">4</div>
	                            <div class="book-title"><a href="bookDetail.jsp?book_id=122">채식주의자</a></div>
	                        ...
	                        <div class="buttons">
	                            <a href="cartAdd.jsp?book_id=122"><button type="button" class="cart-btn"><img src="./../assets/images/cart.jpg">&nbsp;장바구니</button></a>
	                            <a href="orderAdd.jsp?book_id=122"><button type="button" class="buy-btn">바로구매</button></a>
	                        </div>
	                    </div>
	                    ...
	                    <div class="book-item">
	                        ...
	                        <div class="book-image"><a href="bookDetail.jsp?book_id=104">
	                            <img src="./../assets/images/book/torrent.jpg"></a>
	                        </div>
	                        <div class="book-info">
	                            <div class="book-ranking">5</div>
	                            <div class="book-title"><a href="bookDetail.jsp?book_id=104">급류</a></div>
	                        ...
	                        <div class="buttons">
	                            <a href="cartAdd.jsp?book_id=104"><button type="button" class="cart-btn"><img src="./../assets/images/cart.jpg">&nbsp;장바구니</button></a>
	                            <a href="orderAdd.jsp?book_id=104"><button type="button" class="buy-btn">바로구매</button></a>
	                        </div>
	                    </div>
	                    ...
	                    <div class="book-item">
	                        ...
	                        <div class="book-image"><a href="bookDetail.jsp?book_id=110">
	                            <img src="./../assets/images/book/contradiction.jpg"></a>
	                        </div>
	                        <div class="book-info">
	                            <div class="book-ranking">6</div>
	                            <div class="book-title"><a href="bookDetail.jsp?book_id=110">모순</a></div>
	                        ...
	                        <div class="buttons">
	                            <a href="cartAdd.jsp?book_id=110"><button type="button" class="cart-btn"><img src="./../assets/images/cart.jpg">&nbsp;장바구니</button></a>
	                            <a href="orderAdd.jsp?book_id=110"><button type="button" class="buy-btn">바로구매</button></a>
	                        </div>
	                    </div>
	                    ...
	                    <div class="book-item">
	                        ...
	                        <div class="book-image"><a href="bookDetail.jsp?book_id=125">
	                            <img src="./../assets/images/book/unstoppable.jpg"></a>
	                        </div>
	                        <div class="book-info">
	                            <div class="book-ranking">7</div>
	                            <div class="book-title"><a href="bookDetail.jsp?book_id=125">행동하지 않으면 인생은 바뀌지 않는다</a></div>
	                        ...
	                        <div class="buttons">
	                            <a href="cartAdd.jsp?book_id=125"><button type="button" class="cart-btn"><img src="./../assets/images/cart.jpg">&nbsp;장바구니</button></a>
	                            <a href="orderAdd.jsp?book_id=125"><button type="button" class="buy-btn">바로구매</button></a>
	                        </div>
	                    </div>
	                    ...
	                    <div class="book-item">
	                        ...
	                        <div class="book-image"><a href="bookDetail.jsp?book_id=120">
	                            <img src="./../assets/images/book/weDoNotPart.jpg"></a>
	                        </div>
	                        <div class="book-info">
	                            <div class="book-ranking">8</div>
	                            <div class="book-title"><a href="bookDetail.jsp?book_id=120">작별하지 않는다</a></div>
	                        ...
	                        <div class="buttons">
	                            <a href="cartAdd.jsp?book_id=120"><button type="button" class="cart-btn"><img src="./../assets/images/cart.jpg">&nbsp;장바구니</button></a>
	                            <a href="orderAdd.jsp?book_id=120"><button type="button" class="buy-btn">바로구매</button></a>
	                        </div>
	                    </div>
	                    ...
	                    <div class="book-item">
	                        ...
	                        <div class="book-image"><a href="bookDetail.jsp?book_id=116">
	                            <img src="./../assets/images/book/adultHappinessisQuiet.jpg"></a>
	                        </div>
	                        <div class="book-info">
	                            <div class="book-ranking">9</div>
	                            <div class="book-title"><a href="bookDetail.jsp?book_id=116">어른의 행복은 조용하다</a></div>
	                        ...
	                        <div class="buttons">
	                            <a href="cartAdd.jsp?book_id=116"><button type="button" class="cart-btn"><img src="./../assets/images/cart.jpg">&nbsp;장바구니</button></a>
	                            <a href="orderAdd.jsp?book_id=116"><button type="button" class="buy-btn">바로구매</button></a>
	                        </div>
	                    </div>
	                    ...
	                    <div class="book-item">
	                        ...
	                        <div class="book-image"><a href="bookDetail.jsp?book_id=126">
	                            <img src="./../assets/images/book/historyforProgress.jpg"></a>
	                        </div>
	                        <div class="book-info">
	                            <div class="book-ranking">10</div>
	                            <div class="book-title"><a href="bookDetail.jsp?book_id=126">황현필의 진보를 위한 역사</a></div>
	                        ...
	                        <div class="buttons">
	                            <a href="cartAdd.jsp?book_id=126"><button type="button" class="cart-btn"><img src="./../assets/images/cart.jpg">&nbsp;장바구니</button></a>
	                            <a href="orderAdd.jsp?book_id=126"><button type="button" class="buy-btn">바로구매</button></a>
	                        </div>
	                    </div>
	                </section>
            	</div>
