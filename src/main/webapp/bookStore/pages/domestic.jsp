  ...
  <div id="today-2">더보기→</div>
    ...
    <section class="main-content">
        <div class="flex-container">
          <!-- 1열: 오늘의 책 이미지 -->
          <div class="flex-item">
            <a href="./bookDetail.jsp?book_id=107"><img src="../assets/images/dtodaybook.jpg" alt="오늘의 책" id="todaybook"></a>
          </div>
          ...
          <div class="flex-item" id="third-column">
            <div class="grid-container">
              ...
              <div class="grid-item3"><a href="./bookDetail.jsp?book_id=106"><img src="../assets/images/drecommandcount3.jpg"></a></div>
