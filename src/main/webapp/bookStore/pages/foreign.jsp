  ...
  <div id="today-2">더보기→</div>
    ...
    <section class="main-content">
        <div class="flex-container">
          <!-- 1열: 오늘의 책 이미지 -->
          <div class="flex-item">
            <a href="./bookDetail.jsp<%=dquery %>&book_id=127"><img src="../assets/images/ftodaybook.jpg" alt="오늘의 책" id="todaybook"></a>
          </div>
          ...
          <div class="flex-item" id="third-column">
            <div class="grid-container">
              ...
              <div class="grid-item3"><a href="./bookDetail.jsp<%=dquery %>&book_id=131"><img src="../assets/images/frecommandcount2.jpg"></a></div>
              <div class="grid-item3"><a href="./bookDetail.jsp<%=dquery %>&book_id=129"><img src="../assets/images/frecommandcount3.jpg"></a></div>
