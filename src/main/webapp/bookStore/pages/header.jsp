...
<body>
    <header>
            <nav class="top-menu">
                <ul>
                  <li><a href="selectInfo.jsp" target="_parent" id="admin" style="display:none;">전체회원정보</a></li>
                  ...
                  <li><a href="<%=contextPath %>/ControllerMem.do?category=signup" target="_parent">회원가입</a></li>
                  <li><a href="<%=contextPath %>/ControllerMem.do?category=login" id="loginButton" target="_parent">로그인</a></li>
