...
<body>
  ...
  <div id="wrapper">
    ...
    <div class="tab-container">
      ...
      <a href="humanities.jsp<%=dquery %>" class="tab active">인문과학</a>
      <a href="social.jsp<%=dquery %>" class="tab">사회과학</a>
      <a href="science.jsp<%=dquery %>" class="tab">자연과학</a>
    </div>
    ...
    <section class="main-content">
        <div class="flex-container">
          <!-- 1열: 오늘의 책 이미지 -->
          <div class="flex-item">
             <a href="./bookDetail.jsp<%=dquery %>&book_id=123"><img src="../assets/images/dbanner32-1.jpg" alt="오늘의 책" id="todaybook"></a>
          </div>
          ...
          <div class="flex-item" id="third-column">
            <div class="grid-container">
              ...
              <div class="grid-item3"> <a href="./bookDetail.jsp<%=dquery %>&book_id=105"><img src="../assets/images/dbanner40-1.jpg"></a></div>
              <div class="grid-item3"> <a href="./bookDetail.jsp<%=dquery %>&book_id=128"><img src="../assets/images/frecommandcount1.jpg"></a></div>
              <div class="grid-item3"> <a href="./bookDetail.jsp<%=dquery %>&book_id=119"><img src="../assets/images/nrecommandcount1.jpg"></a></div>
