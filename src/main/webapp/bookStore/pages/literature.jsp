...
<body>
  ...
  <div id="wrapper">
    ...
    <div class="tab-container">
      ...
      <a href="literature.jsp<%=dquery %>" class="tab active">문학</a>
  ...
  <div id="today-2">더보기→</div>
    ...
    <section class="main-content">
        <div class="flex-container">
          <!-- 1열: 오늘의 책 이미지 -->
          <div class="flex-item">
            <a href="./bookDetail.jsp<%=dquery %>&book_id=110"><img src="../assets/images/ntodaybook1.jpg" alt="오늘의 책" id="todaybook"></a>
          </div>
          ...
          <div class="flex-item" id="third-column">
            <div class="grid-container">
              ...
              <div class="grid-item3"><a href="./bookDetail.jsp<%=dquery %>&book_id=114"><img src="../assets/images/dbanner31-1.jpg"></a></div>
              <div class="grid-item3"><a href="./bookDetail.jsp<%=dquery %>&book_id=104"><img src="../assets/images/dbanner35-1.jpg"></a></div>
              <div class="grid-item3"><a href="./bookDetail.jsp<%=dquery %>&book_id=122"><img src="../assets/images/dbanner34-1.jpg"></a></div>
