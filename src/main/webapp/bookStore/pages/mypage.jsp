                    ...
                    <div class="aside_body">
                        <div id="AsideMyProfile" class="my_profile_area">
                            <div class="profile_inner">
                                <div class="profile_thumb_box" title="회원수정" style="cursor: pointer;" onclick="window.location.href = './update.jsp'">
                                    <a class="btn_setting" title="회원수정" onclick="window.location.href = './update.jsp'">
