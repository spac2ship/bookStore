    ...
    <div id="wrap">
        <section class="breadcrumb_wrap">
            <div class="breadcrumb_inner">
                <ol id="TopBreadcrumb">
                    <li class="breadcrumb_item_no"><a class="home_link" style="cursor: pointer;" href="../index.jsp<%=bquery %>"></a></li>
                    ...
                    <div class="aside_body">
                        <div id="AsideMyProfile" class="my_profile_area">
                            <div class="profile_inner">
                                <div class="profile_thumb_box" title="회원수정" style="cursor: pointer;" onclick="window.location.href = './update.jsp?id=<%=id%>&pwd=<%=pwd%>'">
                                    <a class="btn_setting" title="회원수정" onclick="window.location.href = './update.jsp?id=<%=id%>&pwd=<%=pwd%>'">
