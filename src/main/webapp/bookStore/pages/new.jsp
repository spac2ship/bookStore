        ...
        <div class="flex-container">
          ...
          <div class="flex-item" id="third-column">
            <div class="grid-container">
              ...
              <div class="grid-item3"><a href="./bookDetail.jsp<%=dquery %>&book_id=115"><img src="../assets/images/nrecommandcount2.jpg"></a></div>
              <div class="grid-item3"><a href="./bookDetail.jsp<%=dquery %>&book_id=121"><img src="../assets/images/nrecommandcount3.jpg"></a></div>
