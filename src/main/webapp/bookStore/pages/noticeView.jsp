...
<div id="wrap">
    ...
    <div class="customer_wrap">
        ...
        %>
        <nav>
            <span ><a id="list" href="javascript:location.href='noticeWrite.jsp?num=<%=vNo%>'">[ 수 정 ]</a></span>
			<span ><a id="list" href="javascript:location.href='noticeDel.jsp?num=<%=vNo%>'">[ 삭 제 ]</a></span>
			<span ><a id="list" href="notice.jsp">[목록보기]</a></span>
        </nav>
        <section>
            <table>
            <%
