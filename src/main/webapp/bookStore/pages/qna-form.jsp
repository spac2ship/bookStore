...
<body>
		...
		vNo = (tmp!=null && tmp.length() > 0) ? Integer.parseInt(tmp) : 0;
     	...
     	if(vNo > 0) {
         	...
         	if(rs.next()) {
         		...
         		vAction = "qnaUpdate.jsp" + bquery + "&num=" + vNo;
         	}
    ...
    <div id="wrapper">
        ...
        <form name="frm" method="post" class = "qna-form" action="<%=vAction %>">
	        <h1><%=currTitle %></h1>
	        <div class="header">
	            <button type="button" class="right-span" onclick="location.href='qnaList.jsp<%=bquery %>'">📜 1:1 문의 내역</button>
	        </div>
            <hr>
