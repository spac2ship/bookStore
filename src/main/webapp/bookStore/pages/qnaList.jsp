...
<body>
    ...
    <div id="wrapper">
        ...
        <form>
	        <h1>1:1 문의 내역</h1>
	        <div class="header">
	            <button type="button" class="left-span" onclick="location.href='qna-form.jsp<%=bquery%>'">✏️ 문의 하기</button>
	        </div>
            ...
            <div class="content">
	            <table id = "tb1">
	                ...
	                %>
	                <tr id = "tr2" onclick="location.href='qnaView.jsp<%=bquery %>&num=<%=vNo%>'">
	            ...
	            <div class="center">
	            	<div class="pagination">
	            		...
	            		%>
	            				<a href = "qnaList.jsp<%=bquery %>&nowBlock=<%=nowBlock-1 %>&nowPage=<%=(nowBlock-1)*pagePerBlock %>">&laquo;</a>
	            		<%
	            		...
	            		%>
	            				<a href ="qnaList.jsp<%=bquery %>&nowBlock=<%=nowBlock %>&nowPage=<%=idx1 %>"
	            		...
	            		%>		
	            				<a href = "qnaList.jsp<%=bquery %>&nowBlock=<%=nowBlock+1 %>&nowPage=<%=(nowBlock+1)*pagePerBlock %>">&raquo;</a>
	            		<%
	            			} else {
