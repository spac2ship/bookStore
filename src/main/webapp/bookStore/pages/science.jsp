...
<body>
  ...
  <div id="wrapper">
    ...
    <div class="tab-container">
      ...
      <a href="science.jsp" class="tab active">자연과학</a>
    </div>
    ...
    <section class="main-content">
        <div class="flex-container">
          <!-- 1열: 오늘의 책 이미지 -->
          <div class="flex-item">
            <a href="./bookDetail.jsp?book_id=124"><img src="../assets/images/dbanner41-1.jpg" alt="오늘의 책" id="todaybook"></a>
          </div>
          ...
          <div class="flex-item" id="third-column">
            <div class="grid-container">
              ...
              <div class="grid-item3"><a href="./bookDetail.jsp?book_id=102"><img src="../assets/images/dbanner42-1.jpg"></a></div>
              <div class="grid-item3"><a href="./bookDetail.jsp?book_id=118"><img src="../assets/images/dbanner43-1.jpg"></a></div>
              <div class="grid-item3"><a href="./bookDetail.jsp?book_id=111"><img src="../assets/images/dbanner44-1.jpg"></a></div>
