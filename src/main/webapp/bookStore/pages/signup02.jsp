    	...
    	<form action="signupAction.jsp" method="post" id="frm">
	        ...
	        <div class="right">
	            ...
	            <div class="input-group">
	                ...
	                <input type="text" name="memValues" id="name" class="input" placeholder="이름을 입력하세요." onkeydown="enter(event)">
	            </div>
	            <div class="input-group">
	                <label for="email">이메일</label>
	                <input type="email" name="memValues" id="email" class="input" placeholder="이메일을 입력하세요." onkeydown="enter(event)">
	            </div>
	            <div class="input-group">
	                <label for="phone">휴대폰 번호</label>
	                <input type="text" name="memValues" id="phone" class="input" placeholder="번호를 입력하세요." onkeydown="enter(event)">
	            </div>
	            <div class="input-group">
	                <label for="add1">주소</label>
	                <input type="text" name="memValues" id="add1" class="input" placeholder="주소를 입력하세요." onkeydown="enter(event)">
	                <input type="text" name="memValues" id="add2" class="input" placeholder="상세주소를 입력하세요." onkeydown="enter(event)">
	            </div>
