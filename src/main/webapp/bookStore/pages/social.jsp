...
<body>
  ...
  <div id="wrapper">
    ...
    <div class="tab-container">
      ...
      <a href="social.jsp" class="tab active">사회과학</a>
    ...
    <section class="main-content">
        <div class="flex-container">
          ...
          <div class="flex-item" id="todayinfo">
            <span id="book-category"><br><br><br>[사회과학]</span><br><br><br>
          ...
          <div class="flex-item" id="third-column">
            <div class="grid-container">
              ...
              <div class="grid-item3"><a href="./bookDetail.jsp?book_id=108"><img src="../assets/images/drecommandcount1.jpg"></a></div>
              <div class="grid-item3"><a href="./bookDetail.jsp?book_id=130"><img src="../assets/images/dbanner33-1.jpg"></a></div>
              <div class="grid-item3"><a href="./bookDetail.jsp?book_id=103"><img src="../assets/images/drecommandcount2.jpg"></a></div>
            ...
            <span class="title">STOP THE STEAL</span><br><br>
            <span class="writer">도태우 외 지음</span><br><br>
            <span class="publishing">스카이</span>
          </div>
