...
<body>
  ...
  <div id="wrapper">
    ...
    <div class="tab-container">
      ...
      <a href="social.jsp<%=dquery %>" class="tab active">사회과학</a>
    ...
    <section class="main-content">
        <div class="flex-container">
          <!-- 1열: 오늘의 책 이미지 -->
          <div class="flex-item">
            <a href="./bookDetail.jsp<%=dquery %>&book_id=100"><img src="../assets/images/ntodaybook.jpg" alt="오늘의 책" id="todaybook"></a>
          </div>
          ...
          <div class="flex-item" id="third-column">
            <div class="grid-container">
              ...
              <div class="grid-item3"><a href="./bookDetail.jsp<%=dquery %>&book_id=130"><img src="../assets/images/dbanner33-1.jpg"></a></div>
